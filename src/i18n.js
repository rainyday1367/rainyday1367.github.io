...
const messages = {
  ko: {
    ...
    resume: {
      ...
      cert2Desc: "'Core Flow' 아키텍처 구축/배포, 백엔드 개발",
      cert3: '강원대 IT대학 졸업작품 우수상',
      cert3Desc: '블록체인 기반 DID 활용 학생 증명서 발급 시스템 ',
      cert4: '정보처리기사',
  ...
  en: {
    ...
    resume: {
      ...
      edu2: 'Gyeongguk National University',
      ...
      cert2Desc: "'Core Flow' architecture build/deployment and backend development.",
      cert3: 'Excellence Award, IT College Graduation Project',
      cert3Desc: 'Blockchain-based DID student certificate issuance system.',
  ...
  ja: {
    ...
    resume: {
      ...
      cert2Desc: "'Core Flow' アーキテクチャ構築/デプロイ、バックエンド開発。",
      cert3: '江原大 IT大学 卒業制作 優秀賞',
      cert3Desc: 'ブロックチェーン基盤のDID活用学生証明書発行システム。',
      cert4: '情報処理技師',
      cert4Desc: '国家公認資格取得。',
      cert5: '運転免許 1種 普通',
      cert5Desc: '普通自動車免許取得。',
